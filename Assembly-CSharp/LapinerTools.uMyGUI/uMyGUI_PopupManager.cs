...
namespace LapinerTools.uMyGUI
{
	public class uMyGUI_PopupManager : MonoBehaviour
	{
		...
		public bool AddPopup(uMyGUI_Popup p_popup, string p_name)
		{
			...
			p_popup.transform.SetParent(canvas.transform, worldPositionStays: false);
		...
		{
			uMyGUI_Popup uMyGUI_Popup = UnityEngine.Object.Instantiate(Resources.Load<uMyGUI_Popup>("popup_" + p_name + "_root"));
			if (uMyGUI_Popup != null && AddPopup(uMyGUI_Popup, p_name))
			{
				return uMyGUI_Popup;
			}
			return null;
