...
namespace PolygonArsenal
{
	public class PolygonButtonScript : MonoBehaviour
	{
		...
		private void Start()
		{
			effectScript = GameObject.Find("PolygonFireProjectile").GetComponent<PolygonFireProjectile>();
			getProjectileNames();
		...
		{
			projectileScript = effectScript.projectiles[effectScript.currentProjectile].GetComponent<PolygonProjectileScript>();
