...
namespace GILES
{
	...
	{
		public override string tooltip => "Scale Tool";
		...
		{
			pb_MonoBehaviourSingleton<pb_SelectionHandle>.instance.SetTool(Tool.Scale);
		}

		private void OnHandleChange()
		{
			base.interactable = (!pb_MonoBehaviourSingleton<pb_SelectionHandle>.instance.GetIsHidden() && pb_MonoBehaviourSingleton<pb_SelectionHandle>.instance.GetTool() != Tool.Scale);
		}
	}
}
