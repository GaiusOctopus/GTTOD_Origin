...
namespace EZCameraShake
{
	...
	public class CameraShaker : MonoBehaviour
	{
		...
		{
			CameraShakeInstance cameraShakeInstance = new CameraShakeInstance(magnitude * CameraShakeModifier, roughness, fadeInTime, fadeOutTime);
		...
		{
			CameraShakeInstance cameraShakeInstance = new CameraShakeInstance(magnitude * CameraShakeModifier, roughness);
			cameraShakeInstance.PositionInfluence = DefaultPosInfluence;
			cameraShakeInstance.RotationInfluence = DefaultRotInfluence;
		...
		{
			Instance.DefaultPosInfluence = new Vector3(0.075f, 0f, 0.075f);
			Instance.DefaultRotInfluence = new Vector3(20f, 2f, 2f);
		}
	}
}
